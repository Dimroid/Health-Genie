...
def send_message(request, username):
    if request.method == 'POST':
        ...
        return render(request, 'account/send_message.html', {'username': username})
...
def user_search(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'account/search_results.html', {'users': users, 'form':form, 'section':'profile_search' })
    else:
        form = UserSearchForm()
    return render(request, 'account/user_search.html', {'form': form, 'section':'profile_search'})
